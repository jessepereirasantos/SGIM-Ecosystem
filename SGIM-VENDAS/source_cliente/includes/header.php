            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="dashboard.php"
                        class="sidebar-item <?= ($current_page == 'dashboard') ? 'active' : '' ?>"><span
                            class="material-symbols-outlined">dashboard</span><span>Início</span></a>

                    <div class="px-4 py-2 mx-2 bg-brand/10 border border-brand/20 rounded-lg mb-2 text-center">
                        <p class="text-[10px] text-brand font-black uppercase tracking-widest">SGIM
                            v<?= SYSTEM_VERSION ?></p>
                    </div>
                    ...
                    <a href="novidades.php" class="sidebar-item <?= ($current_page == 'novidades') ? 'active' : '' ?>">
                        ...
                        <div class="flex justify-between items-center w-full">
                            <span>Comunicados</span><?php if ($unreadCount > 0): ?><span
                                    class="bg-brand text-black text-[9px] font-black px-1.5 py-0.5 rounded-full"><?= $unreadCount ?></span><?php endif; ?>
                        </div>
                    </a>
                </div>
            </div>
